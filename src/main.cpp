...
// Se dejan las instancias tratables que toman milisegundos.
struct InstanciaFB {
    std::string id;
...
// Todas marcadas con costosa=true para evitar exploraciones de billones de nodos sin poda.
const std::vector<VarianteBT> VARIANTES_BT = {
    {"bt_demo_n4",                Politica{4, 1, 1, 1, 1}, false}, // <-- Esta corre en milisegundos (Con Poda vs Sin Poda)
    {"bt_i_completa_n8",         Politica{8, 2, 2, 1, 1}, true},
    {"bt_ii_completa_n6",        Politica{6, 2, 2, 1, 1}, true},
    {"bt_iii_completa_n10",      Politica{10, 2, 2, 1, 1}, true},
    {"bt_iv_relajada_n8",        Politica{8, 1, 0, 0, 0}, true},
